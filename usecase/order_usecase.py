"""주문 실행 Usecase - TWAP 주문 실행 + DB 저장"""
...
class OrderUsecase:
    ...
    def create_buy_order(self, bot_info: BotInfo, seed: float, trade_type: TradeType) -> None:
        """
        매수 주문서 생성
    ...
    def create_sell_order(self, bot_info: BotInfo, amount: int, trade_type: TradeType) -> None:
        """
        매도 주문서 생성
    ...
    def execute_order(self, bot_info: BotInfo) -> None:
        """
        TWAP 주문 실행 (1회)
