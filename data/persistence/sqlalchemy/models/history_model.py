...
class HistoryModel(Base):
    ...
    # 복합 Primary Key: (date_added, trade_date, trade_type, name)
    ...
    def __repr__(self):
        return (f"<HistoryModel(date_added={self.date_added}, trade_date={self.trade_date}, "
                f"trade_type={self.trade_type}, name={self.name}, symbol={self.symbol}, "
                f"buy_price={self.buy_price}, sell_price={self.sell_price}, "
                f"amount={self.amount}, profit={self.profit}, profit_rate={self.profit_rate})>")
