...
class IndicatorLevel:
    ...
    def from_moving_average(current_price: float, ma20: float, ma60: float) -> "IndicatorLevel":
        ...
        if current_price > ma20 and ma20 > ma60:
            return IndicatorLevel(current_price, "강한 상승", "🚀", "strong-uptrend")

        # 주가 > 20일선, 20일선 < 60일선: 약한 상승/전환
        elif current_price > ma20 and ma20 < ma60:
            return IndicatorLevel(current_price, "약한 상승/전환", "📈", "weak-uptrend")

        # 주가 < 20일선, 20일선 > 60일선: 약한 하락/전환
        elif current_price < ma20 and ma20 > ma60:
            return IndicatorLevel(current_price, "약한 하락/전환", "📉", "weak-downtrend")

        # 주가 < 20일선 < 60일선: 강한 하락
        else:  # current_price < ma20 and ma20 < ma60
            return IndicatorLevel(current_price, "강한 하락", "💥", "strong-downtrend")
