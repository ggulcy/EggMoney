...
class History:
    ...
    def __init__(
        ...
        if not isinstance(sell_date, datetime):
            raise ValueError("sell_date must be a datetime object")
    ...
    def __repr__(self):
        return (f"<History(date_added={self.date_added}, sell_date={self.sell_date}, "
                ...
                f"profit=${self.profit:.2f}, profit_rate={self.get_profit_rate_percent()})>")
